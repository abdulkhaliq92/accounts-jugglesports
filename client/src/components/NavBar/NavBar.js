  ...
  <ul className="navbar-nav">
    <li className="logo">
      <a href="/dashboard" className="nav-link">
        <span className="link-text logo-text"><img style={{width: '200px'}} src="https://accounts.jugglesports.com/assets/img/logo-light.png" alt="arc-invoice" crossOrigin="anonymous" /></span>
